...
function onInput(prop, value) {
  ...
  if (prop.target === 'bpmn') {
    emit('update:bpmnData', setPathValue(props.bpmnData, path, value))
  } else {
    emit('update:businessData', setPathValue(props.businessData, path, value))
  }
}
